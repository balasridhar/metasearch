...
<!-- This is the search results page. we also do some client side validation
	 in case the user submits a new query, and some color checks as well
	 for displaying the color coding correctly.
	 Author: Anusha -->
	
<html:html>
	<head>
	<title>EECS 767  Meta Search Engine Results - <%= request.getAttribute("searchString")%> - Page <%= request.getAttribute("pageNumber")%> </title>
		<html:base/>
